...
def main(args: argparse.Namespace):
    ...
    # Generator
    generator = im2mesh.config.get_generator(model, cfg, device=device)
...
if __name__=="__main__":
    ...
    parser.add_argument('--config', type = str, default = "configs/pointcloud/enet_resnet_aligned.yaml", help='Path to config file.')
