...
from im2mesh.onet_vnn import models, training, generation
...
def get_trainer(model, optimizer, cfg, device, **kwargs):
    ...
    latent_reg = cfg['training']['latent_reg']
    latent_reg_scale = cfg['training']['latent_reg_scale']
    ...
    trainer = training.Trainer(
        ...
        latent_reg_scale=latent_reg_scale
    )
