...
class Trainer(BaseTrainer):
    ...
    def visualize(self, data, suffix: Union[str, None] = None):
        ...
        for i in trange(batch_size):
            if suffix is not None:
                input_img_path = os.path.join(self.vis_dir, f'{i:03d}_in_{suffix}.png')
                voxel_img_path = os.path.join(self.vis_dir, f'{i:03d}_{suffix}.png')
            else:
                input_img_path = os.path.join(self.vis_dir, f'{i:03d}_in.png')
                voxel_img_path = os.path.join(self.vis_dir, f'{i:03d}.png')
            vis.visualize_data(
                inputs[i].cpu(), self.input_type, input_img_path)
            vis.visualize_voxels(
                voxels_out[i], voxel_img_path)
